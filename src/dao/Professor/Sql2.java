...
public class Sql2 {
	...
	="select d.name as dname, p.name as pname, p.Major as Major, p.state as state, p.address as address, p.pro_room as room , p.tel as tel, p.email as email from professor p, department d where p.dno = d.dno and p.dno = ?";
