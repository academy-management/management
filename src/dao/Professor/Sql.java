...
public class Sql {
	...
	public static final String SELECT_BY_PROFESSOR_PNO_SQL =
	         "SELECT P.PNO AS PNO, P.PASSWORD AS PASSWORD, P.TEL AS TEL, P.NAME AS NAME, P.ADDRESS AS ADDRESS, P.EMAIL AS EMAIL, D.DNO AS DNO, D.NAME AS DNAME FROM PROFESSOR P INNER JOIN DEPARTMENT D ON P.DNO = D.DNO WHERE P.PNO = ?";
