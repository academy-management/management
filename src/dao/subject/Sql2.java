...
public class Sql2 {
	...
	public static final String SUBJECT_SELECT_ALL2 =
			"select s.name as name, s.grade as grade, to_char(s.startday, 'YYYY.MM.DD') sd, to_char(s.endday, 'YYYY.MM.DD') ed, s.score as score, s.people as people, s.subtime as subtime, s.room as room, s.state as state, s.subno as subno, p.name as pname "
			+ "from subject s "
