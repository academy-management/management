...
<body>
	<div class="wrap">
		<header class="header">
			<div class="logo">
				<h1>
					<a href="#"> <img src="/Academic-Management/img/logo.png"
						alt="메인" />
					</a>
				</h1>
			</div>
					...
					<div class="my_center">
						<form method="post" action="updateProfessorInfo">
							<div class="my_text_edit">
								<label>교번</label><input type="text" class="login_text dis"
									name="pno" value="${member.pno}" readonly />
							</div>
							<div class="my_text_edit">
								<label>학과</label><input type="text" class="login_text"
									name="dname" value="${member.d_name}" readonly />
							</div>
							<div class="my_text_edit">
							...
							<div class="my_text_edit">
								<label>연락처</label><input type="text" class="login_text"
